import {
  useAlignOptions
} from "./chunk-BCL7VBTL.mjs";
import {
  useHeadingOptions
} from "./chunk-K23YHISE.mjs";
import {
  useListOptions
} from "./chunk-U6THAD4G.mjs";
import {
  AlignCenter,
  AlignJustify,
  AlignLeft,
...
var AlignSelectLoaded = lazy(
  () => import("./loaded-MIY725CK.mjs").then((m) => ({
...
var HeadingSelectLoaded = lazy2(
  () => import("./loaded-F37CNCVG.mjs").then((m) => ({
...
var ListSelectLoaded = lazy3(
  () => import("./loaded-H325ZSK5.mjs").then((m) => ({
